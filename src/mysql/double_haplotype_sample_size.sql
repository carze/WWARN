...
CREATE PROCEDURE double_haplotype_sample_size(IN locus1_name VARCHAR(64), IN locus1_pos INT(10), IN locus1_genotype VARCHAR(64),
...
SET @select_string = CONCAT('SELECT s.label, s.investigator, l.country, l.site, ' ,
                            ...
                            '" + ", m2.locus_name, "_", m2.locus_position, "_", g2.value) AS "marker", ');
...
IF group_by = "age" THEN
    ...
    SET @groupby_string = CONCAT('GROUP BY s.label, l.site, p.patient_id');
