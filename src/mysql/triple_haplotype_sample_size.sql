...
CREATE PROCEDURE triple_haplotype_sample_size (IN locus1_name VARCHAR(64), IN locus1_pos INT(10), IN locus1_genotype VARCHAR(64),
...
SET @select_string = CONCAT('SELECT s.label, s.investigator, l.country, l.site, ' ,
                            ...
                            '" +  ", m3.locus_name, "_", m3.locus_position, "_", g3.value) AS "marker", ');
